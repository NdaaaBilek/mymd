...
if (stick.spackname == '' || stick.sauthor == '') {
  var sticker_name = 'Made By NdaaBotz-MD'
...
//========={ SETTING HERE }=========//
    name: "My NdaaBotz-MD",
    version: "1.0.1",
    repo: 'https://github.com/NdaaaXyz/mymd.git',
    browser: ['My-MD by Ndaa', 'Safari', '1.0.0'],
    wm: hias_wm,
    sa: hias_symA,
    sb: hias_symB,
    pack: sticker_name,
